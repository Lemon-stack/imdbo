  ...
  return (
    <>
      ...
      >
        <Link
          href="/"
          className="flex min-h-12 items-center gap-2 rounded-full px-3 py-2 text-sidebar-foreground"
        ...
        <nav className="space-y-1">
          <Link
            href="/dashboard"
            className="flex min-h-10 items-center gap-2 rounded-full bg-sidebar-accent px-3 py-2 text-sm font-semibold text-sidebar-accent-foreground"
          >
          ...
          <button
            type="button"
            onClick={exportCsv}
            className="flex min-h-10 w-full items-center gap-2 rounded-full px-3 py-2 text-left text-sm font-semibold text-sidebar-foreground/75 transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
          >
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="flex min-h-10 items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-sidebar-foreground/75 transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
          >
        ...
        <button
          ...
          className="mt-auto flex min-h-10 w-full items-center gap-2 rounded-full px-3 py-2 text-left text-sm font-semibold text-red-600 transition-colors hover:bg-red-500/10 hover:text-red-700 disabled:pointer-events-none disabled:opacity-60"
        >
